...
//     console.log({
//       hasDueHint: false,
//       'totalHintShowCount > 5': totalHintShowCount > 5,
//       'hintDateString !== ': hintDateString !== '',
//       'dateMethods.compareDates(dateMethods.stringToDate(hintDateString),dateMethods.getCurrentDate(),) === 1':
//         dateMethods.compareDates(
//           dateMethods.stringToDate(hintDateString),
//           dateMethods.getCurrentDate(),
//         ) === 1,
